...
Это позволило нам минимизировать риски и сосредоточиться на ключевых этапах проекта: обучении модели, сравнении с существующей моделью, генерации и оптимизации молекул.
